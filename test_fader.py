...
def test_fades_up_from_the_beginning_of_a_block():
    fad = FadeUpDown(initBlockTime=0, rampTime=1.0, startTime=0, upTime=99999, sampleRate=5)
...
def test_fades_down_from_the_beginning_of_a_block():
    fad = FadeUpDown(initBlockTime=0, rampTime=1.0, startTime=0, upTime=1, sampleRate=5)
...
def test_fades_within_blocks():
    fad = FadeUpDown(initBlockTime=0, rampTime=1.0, startTime=0.5, upTime=1, sampleRate=4)
